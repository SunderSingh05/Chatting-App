  ...
  return <aside className="w-64 bg-base-200 border-r border-base-300 hidden lg:flex flex-col h-screen sticky top-0">
    ...
    <div className="p-5 border-b border-base-300">
      <Link to="/" className="flex items-center gap-2.5">
        ...
        <span className="text-3xl font-bold font-mono bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary tracking-wider" >Chatting App</span>
      </Link>
    </div>
    ...
    <nav className="flex-1 p-4 space-y-1">
      ...
      >
        <HomeIcon className="start-5 text-base-content opacity-70" />
        <span>Home</span>
      </Link>
      ...
      >
        <UserIcon className="start-5 text-base-content opacity-70" />
        <span>Friends</span>
      </Link> */}
      ...
      >
        <BellIcon className="start-5 text-base-content opacity-70" />
